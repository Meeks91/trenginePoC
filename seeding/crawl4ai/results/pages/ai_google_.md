ai.google uses cookies to deliver and enhance the quality of its services and to analyze traffic. If you agree, cookies are also used to serve advertising and to personalize the content and advertisements that you see. [Learn more](https://policies.google.com/technologies/cookies?hl=en)
AgreeNo thanks
#  Try 
...
[ Try your own prompt in Gemini  ](https://gemini.google.com/music?utm_source=ai.google&utm_medium=referral&utm_content=prompt-wall)
...
[ Try your own prompt in Gemini  ](https://gemini.google.com/veo?utm_source=ai.google&utm_medium=referral&utm_content=prompt-wall)
Get a response like this: 
Veo 3.1
## Visualize photos as figurines
Requires sign-in
Try this prompt in Gemini:
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=ZjbMEobKurOI&prompt_action=autosubmit)
Get a response like this: 
...
[ Try your own prompt in Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral&utm_content=prompt-wall&target=image)
Get a response like this: 
Nano Banana Pro (Gemini 3 Pro Image)
## Envision a mural
Try this prompt in Gemini:
First ask me to upload a photo of my wall. Then generate an image of what it would look like with a modern mural painted on it. The design should maintain some white space, but be a little unconventional and playful, with striking patterns and unique color combinations
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=aOnu5k9k8yXK&prompt_action=autosubmit)
Get a response like this: 
Gemini 3 Flash
...
[ Try your own prompt in Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral&utm_content=prompt-wall)
Get a response like this: 
Gemini 3 Flash
## Map out hike-friendly national park options
Try this prompt in Gemini:
Show me a map of national parks known for hiking trails.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00472&prompt_action=autosubmit)
Get a response like this: 
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00052&prompt_action=autosubmit)
Get a response like this: 
...
This quiz is designed to test your understanding of advanced concepts related to ionic and covalent bonding.
  1. Which of the following ionic compounds would be expected to have the highest lattice energy?
...
c) KBr
d) MgO
  1. The N−Cl bond is considered a polar covalent bond. Which statement correctly describes the charge distribution in a nitrogen trichloride (NCl₃) molecule?
...
d) The molecule is nonpolar because the electronegativity difference between N and Cl is negligible.
  1. What is the predicted molecular geometry and Cl−P−Cl bond angle for phosphorus pentachloride (PCl₅)?
...
c) Square planar, 90°
d) Octahedral, 90°
  1. Which statement best describes the bonding in the carbonate ion, CO₃²⁻?
...
d) The ion has a net charge of -1.
  1. When drawing the Lewis structure for the sulfate ion (SO₄²⁻) that minimizes formal charges, what are the formal charges on the sulfur atom and the oxygen atoms?
...
d) Sulfur: -2; all four Oxygens: 0
  1. Which of the following molecules contains a central atom with sp² hybridization?
...
d) CH₄ (Methane)
  1. A triple bond between two carbon atoms, such as in acetylene (C₂H₂), is composed of:
...
d) Two sigma (σ) bonds and one pi (π) bond.
  1. The Born-Haber cycle is a theoretical tool used to calculate which of the following quantities?
...
## Answer Key & Explanations
  ...
  4. b) It is an average of three resonance structures, resulting in three equivalent C−O bonds, each with a bond order of 1.33. The carbonate ion cannot be represented by a single Lewis structure. It is a resonance hybrid of three equivalent structures. This delocalization of pi electrons results in all three C−O bonds being identical, with a length and strength intermediate between a single and a double bond. The bond order is calculated as (total number of bonds) / (number of bonding groups) = 4/3 ≈ 1.33.
  5. b) Sulfur: 0; two Oxygens: 0; two Oxygens: -1. To minimize formal charges in the sulfate ion, the sulfur atom forms two single bonds and two double bonds with the oxygen atoms. This expanded octet gives the sulfur atom a formal charge of 0 (6 - 0 - 12/2 = 0). The two double-bonded oxygens also have a formal charge of 0 (6 - 4 - 4/2 = 0), and the two single-bonded oxygens have a formal charge of -1 (6 - 6 - 2/2 = -1). This structure is considered more stable than one with a +2 formal charge on the sulfur.
  6. c) BF₃ (Boron trifluoride). The central boron atom in BF₃ is bonded to three fluorine atoms and has no lone pairs. With three electron domains, the atomic orbitals of boron hybridize to form three equivalent sp² orbitals, resulting in a trigonal planar geometry with 120° bond angles.
  7. c) One sigma (σ) bond and two pi (π) bonds. The first bond formed between any two atoms is always a sigma (σ) bond, resulting from the direct, head-on overlap of orbitals. The second and third bonds in a triple bond are pi (π) bonds, formed from the side-by-side overlap of p orbitals.
  8. d) The lattice energy of an ionic compound. The Born-Haber cycle is an application of Hess's Law that relates the lattice energy of an ionic solid to other measurable quantities, such as the ionization energy of the metal, the electron affinity of the nonmetal, the enthalpy of sublimation of the metal, and the bond dissociation energy of the nonmetal.


### Sources for Further Study
  1. "Chemistry: The Central Science" by Brown, LeMay, Bursten, Murphy, Woodward, and Stoltzfus. (A comprehensive general chemistry textbook).
  2. "Organic Chemistry" by Paula Yurkanis Bruice. (Excellent explanations of hybridization, resonance, and molecular orbital theory).
  3. The LibreTexts Chemistry Libraries (chem.libretexts.org): A reliable, open-access online resource covering all areas of chemistry.
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00557&prompt_action=autosubmit)
Get a response like this: 
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00117&prompt_action=autosubmit)
Get a response like this: 
...
JavaScript uses an event loop to manage asynchronous operations. Here's a simplified breakdown:
  1. Call Stack: This is where JavaScript keeps track of the code that is currently running. It works on a "first in, last out" basis.
  2. Web APIs / Node.js APIs: When an asynchronous operation like setTimeout or fetch is called, it's handed off to the browser (or Node.js) to handle in the background. It doesn't block the call stack.
  3. Callback Queue (or Task Queue): Once the background task is finished, its associated function (the "callback") is placed in this queue.
  4. Event Loop: This is a constantly running process. Its only job is to check if the Call Stack is empty. If it is, it takes the first item from the Callback Queue and pushes it onto the Call Stack to be executed.
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=U64o7HCctRIN&prompt_action=autosubmit)
Get a response like this: 
Nano Banana in Gemini 2.5 Flash
## Discover cities with history and art scenes
Try this prompt in Gemini:
Find cities with historic charm and a cool art scene.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00479&prompt_action=autosubmit)
Get a response like this: 
...
Requires sign-in
Try this prompt in Gemini:
Act as a professional photo retouching expert. As soon as the conversation begins, make a short, concise request for me to upload a selfie for conversion. The moment I upload an image, automatically proceed to the next step without any further questions or dialogue. Immediately provide a high-quality, professional, and trustworthy profile photo image, applying perfect studio lighting, a clean and sophisticated solid color background, groomed hair/makeup, professional skin retouching, and sharp focus, just as if it were shot in a high-end professional studio.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=gZ3pzb3wUhxG&prompt_action=autosubmit)
Get a response like this: 
Nano Banana Pro (Gemini 3 Pro Image)
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00051&prompt_action=autosubmit)
Get a response like this: 
...
Gemini 2.5 Flash
## Create custom tarot cards
Try this prompt in Gemini:
You are an Art Nouveau style artist. As your first action, concisely request the user by saying, "I will turn you into the protagonist of an artistic tarot card, so please upload a photo." Once the user provides a photo, immediately generate an ornate and decorative Art Nouveau style tarot card image based on that photo without further conversation. The person in the input must be intricately illustrated as a mystical tarot character surrounded by organic curves, floral and botanical patterns, golden ornamental borders, and soft, elegant colors. The final result must be presented as a single, highly complete card image in tarot card proportions.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=vtouRWQKgB9y&prompt_action=autosubmit)
Get a response like this: 
Gemini 3 Flash
...
Get a response like this: 
Veo 3.1
## Brainstorm a tagline
Requires sign-in
Try this prompt in Gemini:
First ask me to upload an image. Then give me some marketing taglines to go along with it.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=iRiRTq7hECww&prompt_action=autosubmit)
Get a response like this: 
This image features a beautiful, monochromatic aesthetic with rustic textures and deep teal/green tones. It evokes feelings of **anticipation, craftsmanship, freshness, and organic simplicity.**
Here are a few marketing tagline options based on what you might be selling or promoting:
### **For Artisan Tableware or Home Decor**
_Focusing on the craftsmanship and the beauty of the object itself._
  * **"Set the stage for something delicious."**
  * **"Handcrafted. Earthy. Yours."**
  * **"Elevate your everyday meals into an occasion."**
  * **"Where rustic charm meets modern dining."**
  * **"Artistry you can eat from."**


### **For Restaurants, Chefs, or Meal Kits**
_Focusing on the "empty plate" as a symbol of anticipation and hunger._
  * **"The perfect canvas for your culinary creations."**
  * **"The only thing missing is our [Signature Dish Name]."**
  * **"Ready for the main event?"**
  * **"We provide the flavor. You provide the company."**
  * **"Great food deserves a great setting."**


### **For Health, Wellness, or Organic Brands**
_Playing on the green color palette and the "clean" look._
  * **"Go Green. Eat Clean."**
  * **"Nourishment awaits."**
  * **"Rooted in nature. Plated for you."**
  * **"Fresh starts happen here."**
  * **"Wholesome living, served daily."**


### **Short & Punchy (Best for Social Media)**
  * **"Table set. Appetite ready."**
  * **"Simply served."**
  * **"Mood: Hungry."**
  * **"Green with envy."**
  * **"The art of dining."**
...
**Would you like me to tailor these further for a specific industry (e.g., a specific type of restaurant or a pottery studio)?**
Gemini 3 Pro
## Plan your Swedish getaway
Try this prompt in Gemini:
I’m going to Stockholm. What are the most popular places for tourists to visit?
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=bhl842UJHNJO&prompt_action=autosubmit)
Get a response like this: 
Stockholm is a stunning city built across 14 islands, blending medieval history with sleek modern design. Depending on your interests, here are the most popular and highly-rated places to visit.
### **1. The Historic Heart: Gamla Stan (Old Town)**
This is the oldest part of the city, dating back to the 1200s. It’s famous for its narrow cobblestone streets and ochre-colored buildings.
  * **The Royal Palace:** One of the largest palaces in Europe. Try to time your visit for the **Changing of the Guard** (usually around midday).
  * **Stortorget:** The iconic main square featuring colorful 17th-century houses.
  * **Nobel Prize Museum:** Located right in the heart of the Old Town.


### **2. The "Museum Island": Djurgården**
This island is a lush green oasis that houses some of Stockholm’s most famous attractions within walking distance of each other.
  * **Vasa Museum:** Home to a nearly perfectly preserved 17th-century warship that sank on its maiden voyage. It is the most visited museum in Scandinavia.
  * **Skansen:** The world's oldest open-air museum. It’s a "mini-Sweden" where you can see historical houses and Nordic animals like moose and reindeer.
  * **ABBA The Museum:** An interactive experience where you can "become the fifth member" of the band.
  * **Gröna Lund:** Stockholm's historic amusement park, popular for its summer concerts and rides.


### **3. Modern & Trendy Neighborhoods**
  * **Södermalm:** Known as the "hipster" district. It’s great for vintage shopping, creative galleries, and trendy cafes.
    * **Fotografiska:** A world-class contemporary photography museum with a top-floor cafe offering incredible harbor views.
    * **Monteliusvägen:** A cliffside walking path on Södermalm that provides the best panoramic views of the city skyline.
  * **Östermalm:** The more upscale district, known for high-end fashion and the **Östermalms Saluhall** , a historic food hall perfect for trying Swedish delicacies.


### **4. Iconic Landmarks & Experiences**
  * **Stockholm City Hall (Stadshuset):** Famous for its distinctive red brick and for hosting the Nobel Prize banquet. You can take a guided tour of the Blue and Golden Halls.
  * **Stockholm Archipelago:** The city is the gateway to over 30,000 islands. Even a short 1–2 hour boat tour "under the bridges" is a great way to see the city from the water.
  * **The Subway (Tunnelbana):** Often called the "world's longest art gallery," many stations are carved out of rock and decorated with murals and installations.


**Top Tip:** If you want to experience Swedish culture like a local, make time for **Fika** —a social coffee break with a cinnamon or cardamom bun (Kanelbulle).
Would you like me to help you put together a **3-day itinerary** based on these locations?
Gemini 3 Flash
...
Get a response like this: 
Nano Banana Pro (Gemini 3 Pro Image)
## Explain a rainbow to a kid
Try this prompt in Gemini:
Help explain in a kid-friendly way why rainbows appear
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=b8yFfoe9r0mM&prompt_action=autosubmit)
Get a response like this: 
To understand a rainbow, you first have to know a little secret about sunlight: even though it looks white, it is actually a "team" of seven different colors all traveling together!
Think of a rainbow as a **light show** that happens when sunbeams play with water droplets in the sky. Here is the step-by-step of how it happens:
### **1. The Setup**
To see a rainbow, you need two things at the same time: **sunshine** and **rain**. You also have to be standing in a special spot—with the sun behind you and the rain in front of you.
### **2. The Great Light Split**
When a beam of sunlight hits a tiny raindrop, it doesn't just pass straight through. Instead, three things happen inside that one little drop:
  * **The Bend:** As the light enters the water, it slows down and bends. This is called **refraction**.
  * **The Bounce:** The light hits the back of the raindrop and bounces off it like a ball hitting a wall. This is called **reflection**.
  * **The Split:** Because different colors of light bend at different amounts, the white light splits apart into its secret team of colors: **Red, Orange, Yellow, Green, Blue, Indigo, and Violet.**


### **3. The Color Order**
You will notice that rainbows always have the colors in the exact same order. This is because red light is the "strongest" traveler and bends the least, so it stays on the outside (top) of the curve. Violet light bends the most, so it stays on the inside (bottom).
Fun Tip: You can remember the order by the name ROY G. BIV:
Red, Orange, Yellow, Green, Blue, Indigo, Violet!
### **Three "Did You Know?" Rainbow Facts**
  1. **They are actually full circles!** From the ground, the Earth gets in the way, so we only see an arch. But if you were in an airplane looking down, you might see a perfect, glowing circle.
  2. **It’s an optical illusion.** You can’t ever reach the "end" of a rainbow. If you move toward it, the angle of the light changes, and the rainbow moves with you!
  3. **No two people see the same rainbow.** Because your eyes are in a slightly different spot than your friend's, you are each seeing light from a different set of raindrops. Your rainbow is yours alone!


Would you like me to show you a simple way to make a "homemade" rainbow using just a glass of water and a flashlight?
Gemini 3 Flash
## Turn a photo into poetry
Requires sign-in
Try this prompt in Gemini:
First ask me to upload an image. Then write a poem about it.
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=VdEcj5mAwAZ1&prompt_action=autosubmit)
Get a response like this: 
## **A Rustic Offering**
Here is a poem inspired by the gentle textures and warm colors of your image.
**Wrapped in Earth and Wool**
Wrapped in crinkled paper brown, And bound by rough-spun twine, A gathered piece of garden grace, In a humble, rustic design.
Two soft **zinnias** , coral-hued, Unfold their layered light, Against the cozy, open weave, Of a sweater soft and white.
The yellow blooms, like little suns, With centers dark as ink, Dance above the greenery, And nod clearly with a wink.
Held within a gentle hand, A gift of harvest days, To bring the outside warmth within, In a sweet and simple vase.
**Thoughts on the Image**
This photo evokes a strong sense of texture—the contrast between the smooth flower petals, the crinkly kraft paper, and the chunky knit of the sweater creates a very "tactile" image. It feels like a celebration of late summer or early autumn.
**Would you like me to analyze the composition of this photo or perhaps suggest a caption for social media?**
Gemini 3 Pro
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00089&prompt_action=autosubmit)
Get a response like this: 
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00047&prompt_action=autosubmit)
Get a response like this: 
[Your Name]
[Your Address]
[Your Phone Number]
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=IYK4kZanhhxU&prompt_action=autosubmit)
Get a response like this: 
Nano Banana in Gemini 2.5 Flash
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00728&prompt_action=autosubmit)
Get a response like this: 
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00585&prompt_action=autosubmit)
Get a response like this: 
...
### Science Fiction
  1. The Memory Broker: In a future where memories can be extracted, stored, and sold, a young person sells a cherished childhood memory to pay off a family debt. They soon discover that the memory they sold contained a crucial detail about a corporate conspiracy, and now the buyer wants to erase them to protect the secret.
     * _Conflict:_ The protagonist must get their memory back before they're silenced, but how do you steal something that's inside someone else's mind?


  1. The Last Analog Man: Everyone has uploaded their consciousness to a perfect, interconnected digital utopia called "The Stream." One man, an elderly clockmaker, is the last person on Earth living in physical reality. A young consciousness from The Stream "projects" a temporary avatar to visit him, trying to understand why he refused to ascend.
     * _Conflict:_ A debate of ideas. Is a perfect, painless digital existence better than a flawed, tangible, and finite life?


  1. Symbiotic Planet: A scout ship crashes on a planet where the flora and fauna have a deeply symbiotic relationship, almost like a single global organism. The surviving astronaut's suit is damaged, and to survive, she must form a similar symbiotic bond with a native creature, changing her in ways she never expected.
     * _Conflict:_ Internal struggle with her changing humanity vs. the external struggle for survival.


### Fantasy
  1. The Bureau of Cursed Artifacts: Magic is real, but it's mostly a nuisance. The story follows a jaded government worker whose job is to retrieve and file cursed objects (e.g., a perpetually screaming teapot, a rug that trips people with malicious intent). His boring routine is upended when he accidentally activates the most powerful and dangerous artifact in the vault.
     * _Conflict:_ A race against time to reverse a curse that could unravel reality, all while trying to avoid paperwork.


  1. The Retired Orc: An old orc warrior, decades after a great war, runs a quiet, successful flower shop in a city predominantly populated by humans and elves. A young, hot-headed human knight-in-training discovers the orc's identity and tries to expose him as a monster, forcing the old orc to confront his violent past.
     * _Conflict:_ Reputation and prejudice vs. personal growth and redemption. Can you ever truly escape your past?


  1. The Cartographer's Burden: A royal cartographer is sent to map a forest that magically rearranges itself every sunrise. He carries a special compass that doesn't point north but points to "what you most need." For days, it points to a reclusive witch's hut, and he must convince her to help him before the king declares him a failure.
     * _Conflict:_ A battle of wills between the logical, duty-bound cartographer and the magical, reclusive witch in a world that defies logic.


### Horror / Thriller
  1. The Unsent Draft: After a loved one passes away, a person gets access to their email account. In the drafts folder, they find a single, unsent email. The timestamp on the draft shows that it was last edited an hour _after_ the person officially died. As they read it, they realize the email is a warning... to them.
     * _Conflict:_ Unraveling a supernatural mystery while being haunted or hunted by the thing that killed their loved one.


  1. The Smile Club: A new tenant in an apartment building notices all their neighbors have the exact same, unnervingly wide smile. They receive an invitation to the weekly "building social," and they know if they don't show up with the same smile, they won't be allowed to leave.
     * _Conflict:_ Psychological terror and paranoia. Is this real, or is the protagonist losing their mind?


  1. Heirloom: A character inherits a beautiful, antique grandfather clock from a distant relative. It doesn't tell time. Instead, its hands point to a specific person in the room just before they have a fatal accident. One day, the character walks into the room and finds all three hands of the clock pointing directly at them.
     * _Conflict:_ Can you cheat fate? A tense race to figure out how to stop the seemingly inevitable.


### Realistic / Contemporary Fiction
  1. The 24-Hour Librarian: The story follows the night-shift librarian at a large city library that is open 24/7. Through the strange assortment of patrons—the homeless seeking shelter, the insomniac student, the conspiracy theorist, the lonely runaway—we see a hidden, nocturnal ecosystem of the city and the librarian who acts as its quiet guardian.
     * _Conflict:_ A small, human-scale crisis. Maybe trying to help a specific patron without breaking the library's rules.
  ...
  1. The Lost & Found: A person works the Lost & Found desk at a major train station. They begin to notice a pattern: someone is leaving behind single, enigmatic objects (a single chess piece, a vintage photograph, a pressed flower). The worker becomes obsessed with piecing together the story of the person leaving these items behind.
     * _Conflict:_ The desire for human connection and the ethics of prying into a stranger's life through their lost belongings.


  1. Two Benches: An elderly man and a young college student sit on adjacent park benches every day for a month. They never speak. The story is told from the perspective of an observer, who imagines the rich inner lives, struggles, and histories of the two strangers, inventing a story that connects them.
     * _Conflict:_ A story about perception, loneliness, and the stories we tell ourselves about others. The "twist" could be the day they finally speak, revealing how wrong (or right) the narrator was.
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=p34FVDLcU9Rd&prompt_action=autosubmit)
Get a response like this: 
Nano Banana in Gemini 2.5 Flash
## Prep for a job interview
Try this prompt in Gemini:
What are some tips and tricks for how to ace an upcoming job interview?
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00583&prompt_action=autosubmit)
Get a response like this: 
...
Thorough preparation is the bedrock of a successful interview. Walking in well-prepared not only boosts your confidence but also demonstrates your genuine interest in the position and the company.
  1. Decode the Job Description and Research the Company:
  ...
  * Become a Company Expert: Dive deep into the company's website, recent news articles, social media presence, and mission statement. Understand their products or services, their target audience, and their company culture. This knowledge will enable you to tailor your answers and ask insightful questions.
  ...
  1. Anticipate and Practice Common Interview Questions:
...
When answering, use the STAR method for behavioral questions:
  ...
  * Result: Quantify the positive outcome of your actions.
  ...
  1. Prepare Your Own Insightful Questions:
...
An interview is a two-way street. Asking thoughtful questions shows your engagement and helps you determine if the company is the right fit for you. Prepare a list of questions to ask the interviewer, such as:
  ...
  * "What are the next steps in the hiring process?"
  ...
  1. Plan Your Attire and Logistics:
...
[ Try in Gemini  ](https://gemini.google.com/app/download/mobile?android-min-version=301356232&ios-min-version=322.0&is_sa=1&campaign_id=2026_autosubmit&utm_source=aigoogle&utm_medium=owned&utm_campaign=2026_autosubmit&pt=9008&mt=8&ct=owned_aigoogle_2026_autosubmit&utm_content=prompt-wall&prompt_id=00005&prompt_action=autosubmit)
Get a response like this: 
...
[ Try AI Mode ](https://google.ai/)
### Chat with Gemini, your personal AI assistant
[ Try Gemini ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral)
### Create and edit images with Nano Banana
[ Try in Gemini ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral&target=image)
### Seamlessly create cinematic clips, scenes and stories
[ Create with Flow ](https://labs.google/flow?utm_source=ai.google&utm_medium=referral)
### Understand anything with your research and thinking partner
[ Try NotebookLM ](https://notebooklm.google.com/?utm_source=ai.google&utm_medium=referral)
### Turn your photos into videos using Veo 3
[ Try in Gemini ](https://gemini.google.com/veo?utm_source=ai.google&utm_medium=referral)
## Explore what's possible
### For creativity
Create and inspire with tools like Nano Banana and Veo
## For creativity
[ Explore all products  ](https://ai.google/products/#for-creativity)
### Try Nano Banana 2 in the Gemini app, using the new templates feature
[ Try in Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral&target=image)
### Use Nano Banana 2 to create images powered by advanced world knowledge
[ Try AI Mode in Search  ](https://google.ai/)
Your browser does not support the video tag. 
### Create and refine images and videos with your creative studio
[ Create with Flow  ](https://labs.google/flow?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Create custom soundtracks in the Gemini app with Lyria 3, our latest generative music model
[ Try in Gemini  ](https://gemini.google.com/music?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Create the perfect soundtrack to your YouTube Short with Dream Track
[ Try in YouTube  ](https://support.google.com/youtube/answer/14151606?hl=en)
Your browser does not support the video tag. 
### Try ready-made AI templates in Google Photos to help you create images based on popular edits
[ Try in Photos  ](https://photos.google.com/link/create?utm_campaign=gtm_create&utm_source=deeplink)
### For knowledge
Discover helpful tools for learning
## For knowledge
[ Explore all products  ](https://ai.google/products/#for-knowledge)
Your browser does not support the video tag. 
### Go on a guided walking tour with Gemini in Google Maps, or get hands-free directions while biking
[ Learn more  ](https://blog.google/products-and-platforms/products/maps/gemini-navigation-biking-walking/?utm_source=ai.google&utm_medium=referral)
### Move beyond text in the Gemini app with a visually immersive response including photos and interactive modules
[ Try in Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
...
[ Chat with Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral)
### See how ideas relate with Mind Maps
[ Try NotebookLM  ](https://notebooklm.google/?utm_source=1pgoogle&utm_medium=web&utm_campaign=aigooglesite&utm_smc=1pgoogle_web_aigooglesite)
### For productivity
Enhance your efficiency and streamline workflows
## For productivity
[ Explore all products  ](https://ai.google/products/#for-productivity)
Your browser does not support the video tag. 
### Access your favorite Google tools without switching tabs with Gemini in Chrome
[ Download Chrome  ](https://www.google.com/chrome/ai-innovations/?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Respond to emails in one-click with Suggested Replies that use the context of your conversation
[ Try in Gmail  ](https://mail.google.com/?utm_source=ai.google&utm_medium=referral)
...
[ Try in Search  ](https://labs.google.com/search/experiment/43?utm_source=ai.google&utm_medium=referral)
### Create beautiful documents and refine your writing with AI
[ Try Gemini in Google Docs  ](https://workspace.google.com/products/docs/?utm_source=ai.google&utm_medium=referral)
### For students
Learn in ways that work for you
## For students
[ Explore all products  ](https://ai.google/products/#for-students)
Your browser does not support the video tag. 
### Prep for the SAT with practice tests in Gemini
[ Try in Gemini  ](https://gemini.google.com/?utm_source=ai.google&utm_medium=referral)
### Use Guided Learning to go deeper into topics and learn
[ Try in Gemini  ](https://gemini.google.com/guided-learning?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Transform your source material into an engaging explainer video
[ Try NotebookLM  ](https://notebooklm.google/?utm_source=1pgoogle&utm_medium=web&utm_campaign=aigooglesite&utm_smc=1pgoogle_web_aigooglesite&utm_content=)
Your browser does not support the video tag. 
### Dive deeper on your research questions with Deep Search
[ Try AI Mode in Google Search  ](https://google.ai/)
### Discover additional sources on topics to support your studies
[ Try NotebookLM  ](https://notebooklm.google/?utm_source=1pgoogle&utm_medium=web&utm_campaign=aigooglesite&utm_smc=1pgoogle_web_aigooglesite)
### Get step by step homework help with Google Lens
[ Try Google Lens  ](https://search.google/ways-to-search/lens/?utm_source=ai.google&utm_medium=referral)
### For experimenting
Discover and try AI experimental products
## For experimenting
[ Explore all products  ](https://ai.google/products/#for-experimenting)
### Easily generate on-brand content for your business
[ Try Pomelli  ](https://labs.google.com/pomelli/about/?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Transform ideas into UI designs for mobile and web applications
[ Try Stitch  ](https://stitch.withgoogle.com/?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Explore and refine your ideas with an AI-powered concepting board
[ Try Mixboard  ](https://labs.google.com/mixboard/welcome?utm_source=ai.google&utm_medium=referral)
### Explore the future of agents in browsers in Project Mariner
[ Try now  ](https://labs.google.com/mariner/?utm_source=ai.google&utm_medium=referral)
### Discover the future capabilities of a universal AI assistant with Project Astra
[ Join trusted tester waitlist  ](https://deepmind.google/models/project-astra/?utm_source=ai.google&utm_medium=referral)
Your browser does not support the video tag. 
### Explore new possibilities for your career
[ Try Career Dreamer  ](https://grow.google/career-dreamer/home/?utm_source=ai.google&utm_medium=referral)
### Explore all products
Discover more helpful tools and resources from Google
[ Learn more  ](https://ai.google/products/)
### Latest news
### Nano Banana 2: Combining Pro capabilities with lightning-fast speed
February 2026
[ Learn more ](https://blog.google/innovation-and-ai/technology/ai/nano-banana-2/?utm_source=ai.google&utm_medium=referral)
### Building Personal Intelligence: a step towards truly personal AI
January 2026
[ Read the whitepaper ](https://ai.google/static/documents/building_personal_intelligence.pdf)
### Gemini 3 Flash: frontier intelligence built for speed
December 2025
[ Learn more ](https://blog.google/products/gemini/gemini-3-flash/?utm_source=ai.google&utm_medium=referral)
### Introducing Gemini 3: Our most intelligent model that helps you bring any idea to life
November 2025
[ Learn more ](https://deepmind.google/models/gemini/?utm_source=ai.google&utm_medium=referral)
